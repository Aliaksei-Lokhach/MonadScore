...
# Запускаем от root, чтобы иметь права на запись в /workspace,
# который будет смонтирован из runner‑а.
USER root
...
# -------------------------------------------------
# Установка Chrome 138 (для тестов)
# -------------------------------------------------
...
# -------------------------------------------------
# Проверка версий (полезно при отладке)
# -------------------------------------------------
...
# -------------------------------------------------
# Рабочая директория (будет смонтирована в workflow)
# -------------------------------------------------
WORKDIR /workspace