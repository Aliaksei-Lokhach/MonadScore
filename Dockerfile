...
# Устанавливаем пользователя root для прав доступа
USER root

# Устанавливаем переменную окружения для автоматической установки
...
# Устанавливаем Chromedriver 138
